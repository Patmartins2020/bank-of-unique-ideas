  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-black via-slate-950 to-neutral-900 text-white px-6 py-12">
      <div className="max-w-xl mx-auto bg-white/10 p-6 rounded-xl border border-white/20">
        <h1 className="text-2xl mb-4 font-semibold text-rose-400">
          Delete Idea — Reason Required
        </h1>

        <textarea
          value={reason}
          onChange={(e) => setReason(e.target.value)}
          placeholder="Enter clear reason for deletion..."
        ...
        <div className="mt-6 flex gap-4">
          <button
            onClick={submit}
            disabled={submitting}
            className="px-5 py-2 rounded bg-rose-500 text-white hover:bg-rose-400 disabled:opacity-60"
          >
